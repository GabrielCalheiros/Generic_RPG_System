...
% ###################################################################################################
% \chapter{Survival and Health Mechanics}
...
% Changes to make:
% 1. make religion06 with bigger (v)
% 2. make personality06 inverted colors
% 3. make religion03 with bigger (v)
% 4. make religion02 with bigger (v)
% 5. make religion07 with bigger (v)
% 6. make religion08 with bigger (v)
% 7. make religion05 with bigger (v)
